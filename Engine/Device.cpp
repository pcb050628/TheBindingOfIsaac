...
void Device::Init(HWND _hwnd, Vec2 _resolution)
{
...
{
	m_ConstantBuffer[(UINT)CB_TYPE::TRANSFORM] = new ConstantBuffer(CB_TYPE::TRANSFORM);
	m_ConstantBuffer[(UINT)CB_TYPE::TRANSFORM]->Create(sizeof(tTransform), 1);
