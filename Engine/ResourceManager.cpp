...
void ResourceManager::CreateDefaultShader()
{
	...
	LoadByFileName<GraphicsShader>(GetContentPath() + L"Resource\\Shader\\Graphics\\default_Shader.txt");

	pShader = new GraphicsShader;
	LoadByFileName<GraphicsShader>(GetContentPath() + L"Resource\\Shader\\Graphics\\debug_Shader.txt");
}
...
void ResourceManager::CreateDefaultMaterial()
{
	...
	LoadByFileName<Material>(GetContentPath() + L"Resource\\Material\\default_Material.txt");

	pMaterial = new Material;
	LoadByFileName<Material>(GetContentPath() + L"Resource\\Material\\debug_Material.txt");
}
