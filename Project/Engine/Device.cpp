...
int Device::Init(HWND _hwnd, Vec2 _resolution)
{
	...
	{
		MessageBoxW(nullptr, L"Edit Render Target View »ý¼º ½ÇÆÐ", L"Device ÃÊ±âÈ­ ½ÇÆÐ", MB_OK);
		return E_FAIL;
	}
...
int Device::CreateConstBuffer()
{
	...
	m_arrConstantBuffer[(UINT)CB_TYPE::MATERIAL_CONST]->Create(sizeof(tMtrlData), 1);
